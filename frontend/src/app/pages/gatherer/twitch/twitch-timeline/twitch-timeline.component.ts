...
@Component({
  ...
  selector: 'ngx-twitch-timeline',
  templateUrl: './twitch-timeline.component.html',
  styleUrls: ['./twitch-timeline.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TwitchTimelineComponent extends BaseChartComponent implements OnInit, AfterViewInit {
  @ViewChild('nbCardTwitchTimeline', { static: true }) private cardContainer: ElementRef;
  ...
  ngOnInit() {
      ...
      console.log("Twitch Timeline Component");
  }
  ...
  ngAfterViewInit() {
      ...
      this.res_date = this.twitchTimelineConvert();
      this.twitchTimeline = this.res_date
  ...
  twitchTimelineConvert(): SingleSeries {
    const res_conv: SingleSeries = [];

    for (const d of this.data.result[4].graphic[6].time) {
      res_conv.push({
