...
def p_twint(username, from_m):
    ...
    presence.append(
        {
            "name": "twitter",
            "children": [
                {"name": "followers", "value": int(profile_df["followers"][0])},
                {"name": "following", "value": int(profile_df["following"][0])},
            ],
        }
    )
    ...
    children = []
    children.append({"name": "Likes", "total": str(profile_df["likes"][0])})
    children.append({"name": "Tweets", "total": str(profile_df["tweets"][0])})
    children.append({"name": "Followers", "total": str(profile_df["followers"][0])})
    children.append({"name": "Following", "total": str(profile_df["following"][0])})
    # children.append({"name": "Listed", "total": result_api.listed_count})
    resume = {"name": "twitter", "children": children}

    popularity.append({"title": "Followers", "value": str(profile_df["followers"][0])})
    # popularity.append({"title": "Listed", "value": result_api.listed_count})
    popularity.append({"title": "Following", "value": str(profile_df["following"][0])})

    approval.append({"title": "Tweets", "value": str(profile_df["tweets"][0])})
    approval.append({"title": "Likes", "value": str(profile_df["likes"][0])})
